...
import com.pyxsasys.fc.social.config.oauth2.OAuth2AuthenticationReadConverter;
import com.pyxsasys.fc.social.domain.util.JSR310DateConverters.*;
...
@Configuration
@EnableMongoRepositories("com.pyxsasys.fc.social.repository")
